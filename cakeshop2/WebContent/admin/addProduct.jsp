...
<form action="addProduct.action" enctype="multipart/form-data" method="post" >
	<table  border="1" cellspacing="0" cellpadding="0" id="main" style="font-size:25;" >
		...
		<tr>
		<td>产品名称</td>
		<td><input style="font-size:25;" type="text" name="proname" placeholder="XXXXXXXXXX"/></td>
		</tr>
		<tr>
		<td>产品价格</td>
		<td><input style="font-size:25;" type="text" name="price" placeholder="例：30.0"/></td>
		</tr>
		<tr>
		<td>产品图片</td>
		<td><input style="font-size:25;" type="file" name="listimg"/></td>
		</tr>
		<tr align="center">
