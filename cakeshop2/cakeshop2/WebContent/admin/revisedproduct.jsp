...
<form action="reviseProduct.action" enctype="multipart/form-data" method="post">
	<table  border="1" cellspacing="0" cellpadding="0" id="main" style="font-size:25;">
						<tr>
							<td>产品ID</td>
							<td><input disabled="true" style="font-size:25;" type="text" value="${revisedProduct.proid}"></td>
						</tr>
						<tr>
							<td>产品名称</td>
							<td><input style="font-size:25;" type="text" value="${revisedProduct.proname }" name="proname"></td>
						</tr>
						<tr>
							<td>产品价格</td>
						...
						<tr>
							<td>产品展示</td>
							<td><img src="${revisedProduct.listimg}" height="75" width="75"/>
							<input style="font-size:25;" type="file" name="listimg"/>
							</td>
						</tr>
						<tr>
							<td>被购买次数</td>
							<td>${revisedProduct.boughtcount}</td>
						</tr>
						<tr align="center">
							<td colspan="2">
								<input type="submit" value="保存修改" onclick="revise()" style="font-size:25;"/>
							</td>
						</tr>
